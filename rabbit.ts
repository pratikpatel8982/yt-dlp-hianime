...
const main = async (embed_url: string, site: string) => {
    ...
    //console.log(real);
    console.log(JSON.stringify({ resp_json, real }));
}

const embed_url: string = process.argv[2];  // First argument: embed_url
const site: string = process.argv[3];      // Second argument: site
main(embed_url, site); //change this value to the embed_url you want
